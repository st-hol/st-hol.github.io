...
/*      console.log(el);
    ...
    /*  var menu_links = document.querySelectorAll(".topnav li a");
for( var adf = 0; adf < menu_links.length; adf++){
        menu_links[adf].addEventListener('click', _paginationHandler);
      }*/
...
function Foo (param){
    var qwerty = document.getElementsByClassName("main");
    console.log(qwerty);
    console.log(qwerty[0]);
    console.log(param);
    qwerty[0].moveTo(qwerty, param);
  }
